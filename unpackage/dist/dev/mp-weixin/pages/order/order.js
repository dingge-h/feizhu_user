...
/***/ 103:
/*!***************************************************************!*\
  !*** D:/飞猪小程序/飞猪用户端/main.js?{"page":"pages%2Forder%2Forder"} ***!
  \***************************************************************/
...
var _order = _interopRequireDefault(__webpack_require__(/*! ./pages/order/order.vue */ 104));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}wx.__webpack_require_UNI_MP_PLUGIN__ = __webpack_require__;
...
/***/ 104:
/*!********************************************!*\
  !*** D:/飞猪小程序/飞猪用户端/pages/order/order.vue ***!
  \********************************************/
/*! no static exports found */
...
/***/ 105:
/*!***************************************************************************!*\
  !*** D:/飞猪小程序/飞猪用户端/pages/order/order.vue?vue&type=template&id=127632e4& ***!
  \***************************************************************************/
...
/***/ 107:
/*!*********************************************************************!*\
  !*** D:/飞猪小程序/飞猪用户端/pages/order/order.vue?vue&type=script&lang=js& ***!
  \*********************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var HMmessages = function HMmessages() {__webpack_require__.e(/*! require.ensure | components/HM-messages/HM-messages */ "components/HM-messages/HM-messages").then((function () {return resolve(__webpack_require__(/*! @/components/HM-messages/HM-messages.vue */ 204));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);}; // 引入数据库
var db = wx.cloud.database();var shopdatabase = db.collection('Shopping');var orderCollection = db.collection('Order'); // 引入微信支付云函数请求
var _default = { components: { HMmessages: HMmessages }, data: function data() {return { homeload: true, orderdata: [], obtainprice: '', name: '', phone: '', carded: '', // 微信支付相关
      Placeorder: '' };}, methods: { // 从购物车查询拉下选中的订单数据
    orDerdata: function orDerdata() {var _this = this;shopdatabase.where({ Selection: 'show' }).get().then(function (res) {_this.orderdata = res.data;_this.homeload = false;}).catch(function (err) {console.log(err);});}, // 支付前解决必填事项
    btnShopping: function btnShopping() {var _this2 = this;(0, _erring.erring)(this.name, this.phone, this.carded).then(function (res) {if (res == 'SUCCESS') {_this2.weChatorder();} else {var icon = 'danger';_this2.tips(res, icon);}}).catch(function (err) {console.log(err);});}, // 下单
    weChatorder: function weChatorder() {var _this3 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var peopleobj, Paymentinfor, ids, ide, commod, Placeorder, Orderinfo, wxpay, paysucc;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:wx.showToast({ title: '正在下单', icon: 'loading', mask: true }); // 出行人对象
                peopleobj = { name: _this3.name, phone: _this3.phone, carded: _this3.carded }; // 把付款的旅游信息和出行人生成已付款的订单[以对象形式存储]
                Paymentinfor = { peopleobj: peopleobj, arrinfo: _this3.orderdata };ids = _this3.orderdata[0].shopid;ide = ids.slice(0, 7);commod = _this3.orderdata[0].title; // 统一下单
                _context.next = 8;return _this3.placeOrder(ide, commod, Paymentinfor);case 8:Placeorder = _context.sent;_context.next = 11;return _this3.orderInfo(Placeorder);case 11:Orderinfo = _context.sent;_context.next = 14;return _this3.wxPay(Orderinfo, Placeorder);case 14:wxpay = _context.sent;_context.next = 17;return _this3.paySucc(Orderinfo, Placeorder);case 17:paysucc = _context.sent;case 18:case "end":return _context.stop();}}}, _callee);}))();},
    // 统一下单
...
/***/ 111:
/*!*****************************************************************************!*\
  !*** D:/飞猪小程序/飞猪用户端/pages/order/order.vue?vue&type=style&index=0&lang=css& ***!
  \*****************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
